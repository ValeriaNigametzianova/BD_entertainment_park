...
import {useMessageFormatter as $i081u$useMessageFormatter} from "@react-aria/i18n";
...
function $dafd15390222438a$export$452b38fce62c9384(props, ref) {
    ...
    let { linkProps: linkProps  } = $i081u$useLink({
...
function $848231d7a2b3998e$export$8cefe241bd876ca0(props) {
    ...
    let formatMessage = $i081u$useMessageFormatter((/*@__PURE__*/$parcel$interopDefault($28dc7e2f5ed40c80$exports)));
    return {
        navProps: {
            ...$i081u$filterDOMProps(otherProps, {
                labelable: true
            }),
