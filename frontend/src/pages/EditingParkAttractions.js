...
const EditingParkAttractions = () => {
  ...
  useEffect(() => {
    ...
    stuffFetchAttraction(id).then((data) => setAttraction(data))
  }, [])
  console.log('el', park)
  console.log('elll', attractions)
              ...
              attractions.attractions.map((el) => (
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <Form.Control
                    ...
                    defaultValue={el?.weight_limitation}
                  ...
                  <Form.Control
                    ...
                    defaultValue={el?.hight_limitation}
                  ...
                  <Form.Control
                    ...
                    defaultValue={el?.age_limitation}
                  ...
                  <Form.Control
                    ...
                    defaultValue={el?.max_quantity_people}
