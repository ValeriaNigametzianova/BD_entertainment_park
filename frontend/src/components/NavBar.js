      ...
      {user.isAuth ? (
        <Container>
          <Navbar.Brand
            ...
            style={{ color: '#79273D', cursor: 'pointer' }}
          >
        ...
        <Container>
          ...
          {park.selectedTown ? (
            <DropdownButton variant="outline-success" title={park.selectedTown}>
            ...
            <DropdownButton variant="outline-success" title="Выберите город">
              {park.towns.map((town, id) => (
                <Dropdown.Item
                  className="dropdown-item"
                  key={id}
